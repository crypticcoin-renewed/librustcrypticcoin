...
/// External ovk used by crypticcoind for transparent -> shielded spends to
/// external receivers.
...
mod tests {
    ...
    fn check_ovk_test_vectors() {
        ...
        // From https://github.com/crypticcoin-hackworks/crypticcoin-test-vectors/blob/master/zip_0316.py
