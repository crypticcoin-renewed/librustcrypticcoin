...
pub trait Parameters: Clone {
    ...
    /// applies.
    ///
    /// [`TransparentAddress::PublicKey`]: crypticcoin_primitives::legacy::TransparentAddress::PublicKey
    fn b58_pubkey_address_prefix(&self) -> [u8; 2];

    /// Returns the human-readable prefix for Base58Check-encoded transparent pay-to-script-hash
    /// payment addresses for the network to which this Parameters value applies.
    ///
    /// [`TransparentAddress::Script`]: crypticcoin_primitives::legacy::TransparentAddress::Script
