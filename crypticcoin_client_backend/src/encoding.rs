...
//! [crypticcoin_primitives::constants][constants] module.
//!
//! [constants]: crypticcoin_primitives::constants
...
/// ```
/// [`ExtendedSpendingKey`]: crypticcoin_primitives::zip32::ExtendedSpendingKey
...
///     keys::sapling,
/// };
/// use crypticcoin_primitives::zip32::ExtendedFullViewingKey;
///
/// let extsk = sapling::spending_key(&[0; 32][..], COIN_TYPE, AccountId(0));
...
/// );
/// ```
/// [`PaymentAddress`]: crypticcoin_primitives::sapling::PaymentAddress
...
/// );
/// ```
/// [`TransparentAddress`]: crypticcoin_primitives::legacy::TransparentAddress
