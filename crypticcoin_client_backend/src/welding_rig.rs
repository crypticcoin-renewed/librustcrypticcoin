...
use crypticcoin_note_encryption::{ShieldedOutput, COMPACT_NOTE_SIZE};
...
///
/// [`SaplingIvk`]: crypticcoin_primitives::sapling::SaplingIvk
...
/// [`ScanningKey`]: crate::welding_rig::ScanningKey
/// [`CommitmentTree`]: crypticcoin_primitives::merkle_tree::CommitmentTree
/// [`IncrementalWitness`]: crypticcoin_primitives::merkle_tree::IncrementalWitness
