...
use crypticcoin_primitives::constants;

use crypticcoin_primitives::sapling::{
...
fn test_input_circuit_with_bls12_381() {
    ...
    use crypticcoin_primitives::sapling::{pedersen_hash, Diversifier, Note, ProofGenerationKey, Rseed};
...
fn test_output_circuit_with_bls12_381() {
    ...
    use rand_core::{RngCore, SeedableRng};
    use rand_xorshift::XorShiftRng;
    use crypticcoin_primitives::sapling::{Diversifier, ProofGenerationKey, Rseed};
