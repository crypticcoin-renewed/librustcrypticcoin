...
mod test {
    ...
    fn test_edwards_fixed_base_multiplication() {
        ...
        for _ in 0..100 {
            ...
            let p = crypticcoin_primitives::constants::NOTE_COMMITMENT_RANDOMNESS_GENERATOR;
    ...
    fn test_assert_not_small_order() {
        ...
        // is user input verified? https://github.com/crypticcoin-renewed/librustcrypticcoin/blob/f5d2afb4eabac29b1b1cc860d66e45a5b48b4f88/src/rustcrypticcoin.rs#L299
    }
}
