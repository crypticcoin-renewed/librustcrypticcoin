...
/// `crypticcoin_primitives::extensions::transparent::Extension` method invocations.
pub struct Program;
...
/// Wrapper for [`crypticcoin_primitives::transaction::builder::Builder`] that simplifies
...
/// Convenience methods for use with [`crypticcoin_primitives::transaction::builder::Builder`]
