...
//! [`WalletWrite`] traits.
//!
//! [`WalletRead`]: crypticcoin_client_backend::data_api::WalletRead
//! [`WalletWrite`]: crypticcoin_client_backend::data_api::WalletWrite
...
use crypticcoin_client_backend::{
...
use crypticcoin_primitives::legacy::TransparentAddress;

#[cfg(feature = "transparent-inputs")]
use {
    crate::UtxoId,
    crypticcoin_client_backend::{encoding::AddressCodec, wallet::WalletTransparentOutput},
...
/// ```
#[deprecated(
    note = "This function will be removed in a future release. Use crypticcoin_client_backend::data_api::WalletRead::get_address instead."
)]
...
///
/// [`ExtendedFullViewingKey`]: crypticcoin_primitives::zip32::ExtendedFullViewingKey
#[deprecated(
    note = "This function will be removed in a future release. Use crypticcoin_client_backend::data_api::WalletRead::get_extended_full_viewing_keys instead."
)]
...
/// [`ExtendedFullViewingKey`]: crypticcoin_primitives::zip32::ExtendedFullViewingKey
#[deprecated(
    note = "This function will be removed in a future release. Use crypticcoin_client_backend::data_api::WalletRead::is_valid_account_extfvk instead."
)]
...
/// ```
#[deprecated(
    note = "This function will be removed in a future release. Use crypticcoin_client_backend::data_api::WalletRead::get_balance_at instead."
)]
...
/// ```
/// use tempfile::NamedTempFile;
/// use crypticcoin_primitives::consensus::Network;
/// use crypticcoin_client_sqlite::{
///     NoteId,
///     WalletDb,
...
/// ```
#[deprecated(
    note = "This function will be removed in a future release. Use crypticcoin_client_backend::data_api::WalletRead::get_memo instead."
)]
...
/// ```
#[deprecated(
    note = "This function will be removed in a future release. Use crypticcoin_client_backend::data_api::WalletRead::block_height_extrema instead."
)]
...
/// use tempfile::NamedTempFile;
/// use crypticcoin_primitives::consensus::Network;
/// use crypticcoin_primitives::transaction::TxId;
/// use crypticcoin_client_sqlite::{
///     WalletDb,
...
/// ```
#[deprecated(
    note = "This function will be removed in a future release. Use crypticcoin_client_backend::data_api::WalletRead::get_tx_height instead."
)]
...
/// ```
/// use tempfile::NamedTempFile;
/// use crypticcoin_primitives::consensus::{H0, Network};
/// use crypticcoin_client_sqlite::{
///     WalletDb,
...
/// ```
#[deprecated(
    note = "This function will be removed in a future release. Use crypticcoin_client_backend::data_api::WalletRead::get_block_hash instead."
)]
...
/// ```
/// use tempfile::NamedTempFile;
/// use crypticcoin_primitives::consensus::{Network, H0};
/// use crypticcoin_client_sqlite::{
///     WalletDb,
...
/// ```
#[deprecated(
    note = "This function will be removed in a future release. Use crypticcoin_client_backend::data_api::WalletRead::get_commitment_tree instead."
)]
...
/// ```
#[deprecated(
    note = "This function will be removed in a future release. Use crypticcoin_client_backend::data_api::WalletRead::get_witnesses instead."
)]
...
#[deprecated(
    note = "This function will be removed in a future release. Use crypticcoin_client_backend::data_api::WalletRead::get_nullifiers instead."
)]
...
#[deprecated(
    note = "This function will be removed in a future release. Use crypticcoin_client_backend::data_api::WalletWrite::advance_by_block instead."
)]
...
#[deprecated(
    note = "This function will be removed in a future release. Use crypticcoin_client_backend::data_api::WalletWrite::store_decrypted_tx instead."
)]
...
#[deprecated(
    note = "This function will be removed in a future release. Use crypticcoin_client_backend::data_api::WalletWrite::store_sent_tx instead."
)]
...
#[cfg(feature = "transparent-inputs")]
#[deprecated(
    note = "This method will be removed in a future update. Use crypticcoin_client_backend::data_api::WalletWrite::rewind_to_height instead."
)]
...
#[deprecated(
    note = "This method will be removed in a future release. Use crypticcoin_client_backend::data_api::WalletWrite::store_decrypted_tx instead."
)]
#[allow(deprecated)]
...
#[deprecated(
    note = "This method will be removed in a future update. Use crypticcoin_client_backend::data_api::WalletWrite::advance_by_block instead."
)]
...
#[deprecated(
    note = "This method will be removed in a future update. Use crypticcoin_client_backend::data_api::WalletWrite::store_decrypted_tx instead."
)]
#[allow(deprecated)]
...
///   the transaction.
#[deprecated(
    note = "This method will be removed in a future update. Use crypticcoin_client_backend::data_api::WalletWrite::store_sent_tx instead."
)]
...
mod tests {
    ...
    use crypticcoin_primitives::transaction::components::Amount;

    use crypticcoin_client_backend::data_api::WalletRead;
