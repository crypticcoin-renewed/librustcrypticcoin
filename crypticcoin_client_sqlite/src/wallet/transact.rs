...
use crypticcoin_client_backend::wallet::SpendableNote;
...
#[deprecated(
    note = "This method will be removed in a future update. Use crypticcoin_client_backend::data_api::WalletRead::get_spendable_sapling_notes instead."
)]
...
#[deprecated(
    note = "This method will be removed in a future update. Use crypticcoin_client_backend::data_api::WalletRead::select_spendable_sapling_notes instead."
)]
...
mod tests {
    ...
    use crypticcoin_proofs::prover::LocalTxProver;
    ...
    use crypticcoin_primitives::legacy::keys as transparent;
    ...
    fn test_prover() -> impl TxProver {
        match LocalTxProver::with_default_location() {
            ...
            None => {
                panic!("Cannot locate the Zcash parameters. Please run crypticcoin-fetch-params or fetch-params.sh to download the parameters, and then re-run the tests.");
            }
        }
    }
