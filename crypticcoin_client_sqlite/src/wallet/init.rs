...
use {
    ...
    crypticcoin_primitives::legacy::keys::IncomingViewingKey,
};
...
/// [`scan_cached_blocks`]: crypticcoin_client_backend::data_api::chain::scan_cached_blocks
/// [`create_spend_to_address`]: crypticcoin_client_backend::data_api::wallet::create_spend_to_address
...
mod tests {
    ...
    use crypticcoin_client_backend::keys::{sapling, UnifiedFullViewingKey, UnifiedSpendingKey};
