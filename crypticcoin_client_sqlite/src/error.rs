...
use crypticcoin_client_backend::{data_api, encoding::TransparentCodecError};
use crypticcoin_primitives::consensus::BlockHeight;
...
pub enum SqliteClientError {
    ...
    InvalidMemo(crypticcoin_primitives::memo::Error),
    ...
    /// Wrapper for errors from crypticcoin_client_backend
...
impl From<crypticcoin_primitives::memo::Error> for SqliteClientError {
    fn from(e: crypticcoin_primitives::memo::Error) -> Self {
