...
//!
//! `crypticcoin_client_sqlite` contains complete SQLite-based implementations of the [`WalletRead`],
//! [`WalletWrite`], and [`BlockSource`] traits from the [`crypticcoin_client_backend`] crate. In
//! combination with [`crypticcoin_client_backend`], it provides a full implementation of a SQLite-backed
...
//! [`BlockSource`]: crypticcoin_client_backend::data_api::BlockSource
//! [`CompactBlock`]: crypticcoin_client_backend::proto::compact_formats::CompactBlock
...
use {
    ...
    crypticcoin_primitives::legacy::TransparentAddress,
};
...
/// consistent with the bound in crypticcoind, and allows block data deeper than
...
mod tests {
    ...
    #[cfg(feature = "transparent-inputs")]
    use crypticcoin_primitives::{legacy, legacy::keys::IncomingViewingKey};
